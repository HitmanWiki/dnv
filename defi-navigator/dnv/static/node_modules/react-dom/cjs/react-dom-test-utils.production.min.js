    ...
    h(b.prototype, {
        preventDefault: function() {
            ...
            a && (a.preventDefault ? a.preventDefault() : "unknown" !== typeof a.returnValue &&
                (a.returnValue = !1), this.isDefaultPrevented = v)
        },
...
var na = h({}, z, {
    ...
    which: function(a) {
        return "keypress" ===
            a.type ? u(a) : "keydown" === a.type || "keyup" === a.type ? a.keyCode : 0
    }
});
x(na);
var oa = h({}, E, {
...
function Pa(a, b) {
    ...
    if (a) return null;
    if (c && "function" !== typeof c) throw Error(p(231,
        b, typeof c));
    return c
}
    ...
    return function(b, c) {
        ...
        m.unstable_batchedUpdates(function() {
            ...
            if (f) {
                ...
                if (Array.isArray(a))
                    for (var d = 0; d < a.length && !f.isPropagationStopped(); d++) Na(f,
                        a[d], c[d]);
                else a && Na(f, a, c);
